...
INSERT INTO `aspnetusers` VALUES ('ce0df121-281f-4ca3-9d75-62baa6aae604','4a463e91-1d03-4514-a0f9-14ec9831eba9','root@gmail.com',1,'AQAAAAIAAYagAAAAEKw4h4RqZsXdFQYk45veQ7kXA0xN8PyEIeLkWoEpGmrquxI8fxEn+Ci4/1X/Z3dm8g==','GX5D4XXFX7FUMZGOLAFTFFUUQVNXGXZI',NULL,0,0,NULL,1,0,'root@gmail.com',NULL,'ROOT@GMAIL.COM','ROOT@GMAIL.COM');
...
CREATE TABLE `book` (
  ...
  `currently_at` varchar(100) NOT NULL,
  PRIMARY KEY (`id_book`),
  KEY `book_category_FK` (`id_category`),
  CONSTRAINT `book_category_FK` FOREIGN KEY (`id_category`) REFERENCES `category` (`id_category`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_german2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `series` (
  ...
  KEY `series_category_FK` (`id_category`),
  CONSTRAINT `series_category_FK` FOREIGN KEY (`id_category`) REFERENCES `category` (`id_category`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_german2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'watchlist'
--
...
-- Dump completed on 2023-12-27 14:21:24
